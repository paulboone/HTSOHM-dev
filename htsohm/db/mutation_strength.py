...
class MutationStrength(Base):
    ...
    Attributes:
        ...
        gas_loading_bin (int): value representing a region of gas
    ...
    __table_args__ = (
        PrimaryKeyConstraint('run_id', 'generation', 'gas_loading_bin', 'surface_area_bin', 'void_fraction_bin'),
    )

    def __init__(self, run_id=None, generation=None, gas_loading_bin=None,
                 surface_area_bin=None, void_fraction_bin=None, strength=None):
        self.run_id = run_id
        self.generation = generation
        self.gas_loading_bin = gas_loading_bin
        self.surface_area_bin = surface_area_bin
        self.void_fraction_bin = void_fraction_bin
        self.strength = strength

    @classmethod
    def get_prior(cls, run_id, generation, gas_loading_bin, surface_area_bin, void_fraction_bin):
        """
        ...
        ms = session.query(MutationStrength) \
                .filter(
                    ...
                    MutationStrength.gas_loading_bin == gas_loading_bin,
        ...
        if ms:
            ...
            return MutationStrength(run_id, generation, gas_loading_bin, surface_area_bin,
